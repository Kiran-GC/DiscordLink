...
// src/evals/deprecated.ts
var onlineEvalWarned = false;
function warnOnlineEvalDeprecation() {
  if (onlineEvalWarned) return;
  onlineEvalWarned = true;
  console.warn(
    `[axiom] Importing onlineEval from 'axiom/ai' is deprecated. Use "import { onlineEval } from 'axiom/ai/evals/online'" instead.`
  );
}
...
// src/index.ts
var onlineEval2 = (...args) => {
  warnOnlineEvalDeprecation();
  return onlineEval(...args);
};
export {
  RedactionPolicy,
  axiomAIMiddleware,
