...
[axiom](../../README.md) / [evals](../README.md) / AxiomReporter
...
> **new AxiomReporter**(): `AxiomReporter`
...
> **onTestRunEnd**(`_testModules`, `_errors`, `_reason`): `Promise`\<`void`\>
...
> **onTestSuiteReady**(`_testSuite`): `Promise`\<`void`\>
...
`Reporter.onTestSuiteReady`

***

### onTestSuiteResult()

> **onTestSuiteResult**(`testSuite`): `Promise`\<`void`\>
