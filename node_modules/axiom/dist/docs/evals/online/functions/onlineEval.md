...
[axiom](../../../README.md) / [evals/online](../README.md) / onlineEval

# Function: onlineEval()

> **onlineEval**\<`TInput`, `TOutput`, `Name`, `TScorers`\>(`name`, `params`): `Promise`\<`Partial`\<`Record`\<`Extract`\<`InferScorerName`\<`TScorers`\[`number`\]\>, `string`\>, `InferOnlineEvalResult`\<`TScorers`\>\>\>\>
...
Eval name (A-Z, a-z, 0-9, -, _ only). Used as the span name and `eval.name` attribute.

### params

[`OnlineEvalParams`](../type-aliases/OnlineEvalParams.md)\<`TInput`, `TOutput`, `TScorers`\>

Evaluation configuration

## Returns

`Promise`\<`Partial`\<`Record`\<`Extract`\<`InferScorerName`\<`TScorers`\[`number`\]\>, `string`\>, `InferOnlineEvalResult`\<`TScorers`\>\>\>\>

Promise resolving to scorer results keyed by scorer name
