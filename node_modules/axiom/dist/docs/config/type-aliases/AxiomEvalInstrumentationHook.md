...
[axiom](../../README.md) / [config](../README.md) / AxiomEvalInstrumentationHook

# Type Alias: AxiomEvalInstrumentationHook()

> **AxiomEvalInstrumentationHook** = (`options`) => `AxiomEvalInstrumentationResult` \| `Promise`\<`AxiomEvalInstrumentationResult`\>
...
TracerProvider or Promise resolving to TracerProvider
