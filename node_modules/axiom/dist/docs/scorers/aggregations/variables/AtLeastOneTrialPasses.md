...
[axiom](../../../README.md) / [scorers/aggregations](../README.md) / AtLeastOneTrialPasses

# Variable: AtLeastOneTrialPasses()

> `const` **AtLeastOneTrialPasses**: (`opts`) => [`Aggregation`](../type-aliases/Aggregation.md)\<`"pass@k"`\> = `PassAtK`
...
The minimum score required for a trial to pass
